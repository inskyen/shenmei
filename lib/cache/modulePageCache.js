...
export function removePostFromModuleCaches(postId) {
  modulesCache = null;

  modulePageCache.forEach((page, slug) => {
    modulePageCache.set(slug, {
      ...page,
...
export function adjustModulePostCommentCount(postId, delta) {
  modulePageCache.forEach((page, slug) => {
    modulePageCache.set(slug, {
      ...page,
